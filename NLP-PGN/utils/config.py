...
data_path: str = './data/bdci_data/fixed_train.txt' #'./data/data/dev.txt'
val_data_path = './data/bdci_data/fixed_dev.txt'
test_data_path = './data/bdci_data/fixed_test.txt'
stop_word_file = './data/data/HIT_stop_words.txt'
max_src_len: int = 1500 #300  # exclusive of special tokens such as EOS
max_tgt_len: int = 256 #100  # exclusive of special tokens such as EOS

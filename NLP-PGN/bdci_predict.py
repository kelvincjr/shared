...
from utils.utils import source2ids, outputids2words, Beam, add2heap, replace_oovs
...
class Predict():
    ...
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load(os.path.join(config.output_dir, "best_model.pkl"), map_location='cpu'))

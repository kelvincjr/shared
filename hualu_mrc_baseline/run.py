...
from dataset.dataset_hualu import MrcDataset
...
import logging
tf_logger = logging.getLogger(__name__)
...
def main():
    ...
    train_dataset = MrcDataset(args,
                               json_path="./hualu_data/phase2_A_train.csv",
                               tokenizer=tokenizer)

    eval_dataset = MrcDataset(args,
                              json_path="./hualu_data/phase2_A_dev.csv",
                              tokenizer=tokenizer)

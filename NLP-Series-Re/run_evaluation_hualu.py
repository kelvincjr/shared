...
def convert_spo_contour2(qids, end_list, subjects_str, output_logits, eval_file, answer_dict):
    for qid, output_logit in zip(qids.data.cpu().numpy(),
        ...
        for i in range(len(s_e_o[0])):
            ...
            #print('s_end: {}, o_end: {}, predicate: {}'.format(s_end, o_end, predicate))
            #print('end_list[qid]: ', end_list[qid])
        ...
        for subject in subjects:
            ...
            print(context[tok_to_orig_start_index[subject[0] - 1]:tok_to_orig_end_index[subject[1] - 1] + 1])
        
        print('len of spoes: ', len(spoes))
        for s, po in spoes.items():
            ...
            for (o1, o2, p) in po:
                ...
                print('sub_ent {}, obj_ent {}'.format(sub_ent, obj_ent))         
        import sys
        sys.exit()
        '''
        ...
        for s, po in spoes.items():
            ...
            for (o1, o2, p) in po:
                ...
                po_predict.append({
                    ...
                    "object_start": tok_to_orig_start_index[o1 - 1],
                    "subject": sub_ent,
